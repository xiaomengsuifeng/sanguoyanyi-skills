...
OUTPUT_FILE = os.path.join(SCRIPT_DIR, "曹操全文提取.txt")

def extract_caocao_content():
    """提取所有包含曹操相关称呼的段落"""

    # 曹操的所有称呼
    keywords = ["曹操", "孟德", "魏王", "曹孟德", "阿瞒"]
    ...
    all_content.append("三国演义 - 曹操相关段落全文提取")
    all_content.append("=" * 80)
    all_content.append("")
    ...
    print(f"曹操出现的回数: {count}/120")

if __name__ == "__main__":
    extract_caocao_content()