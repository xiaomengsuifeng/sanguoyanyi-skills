...
OUTPUT_FILE = os.path.join(SCRIPT_DIR, "关羽全文提取.txt")

def extract_guanyu_content():
    """提取所有包含关羽相关称呼的段落"""

    # 关羽的所有称呼
    keywords = ["关羽", "云长", "关公", "美髯公"]
    ...
    all_content.append("三国演义 - 关羽相关段落全文提取")
    all_content.append("=" * 80)
    all_content.append("")
    ...
    print(f"关羽出现的回数: {count}/120")

if __name__ == "__main__":
    extract_guanyu_content()