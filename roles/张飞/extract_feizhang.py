...
OUTPUT_FILE = os.path.join(SCRIPT_DIR, "张飞全文提取.txt")

def extract_feizhang_content():
    """提取所有包含张飞相关称呼的段落"""

    # 张飞的所有称呼
    keywords = ["张飞", "翼德", "张翼德", "燕人"]
    ...
    all_content.append("三国演义 - 张飞相关段落全文提取")
    all_content.append("=" * 80)
    all_content.append("")
    ...
    print(f"张飞出现的回数: {count}/120")

if __name__ == "__main__":
    extract_feizhang_content()