...
OUTPUT_FILE = os.path.join(SCRIPT_DIR, "诸葛亮全文提取.txt")

def extract_zhugeliang_content():
    """提取所有包含诸葛亮相关称呼的段落"""

    # 诸葛亮的所有称呼
    keywords = ["诸葛亮", "孔明", "卧龙", "诸葛", "武侯"]
    ...
    all_content.append("三国演义 - 诸葛亮相关段落全文提取")
    all_content.append("=" * 80)
    all_content.append("")
    ...
    print(f"诸葛亮出现的回数: {count}/120")

if __name__ == "__main__":
    extract_zhugeliang_content()